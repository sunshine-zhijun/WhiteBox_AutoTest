...
import os
import allure
from code.forward_policies.get_for_2 import *
...
@pytest.mark.parametrize("data", [{'parameter': {'1': {'configuration': {'evif_name': 'egroup3'}}}, 'exp': {'C1': ['policy1'], 'C3': ['policy3'], 'C2': ['policy1']}, 'mock_value': {'egroup.get_egroup_interfaces': ['C3']}}])
@pytest.mark.sss
class Test_get_for_2():
    ...
    def test_get_for_2(data):
        ...
        find = get_fb.get_egress_port_keys_of_policy_name_todict(1=parameter['1'])
